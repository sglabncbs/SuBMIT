...
trjformat = "xtc"
sbm_CA.createReporters(trajectory=True,trajectoryFormat=trjformat, energies=True, energy_components=True, interval=1000,checkpoint=True, checkpointInterval=1000) #not supported in default version



#report is for verbose
#for appending/extending simulations
#sbm_CA.simulation.loadCheckpoint("U_Output_01/Output_checkpoint.chk")      
#sbm_CA.simulation.loadCheckpoint("endfile.chk")
#sbm_CA.simulation.loadState("endfile.state")
#mdrun

sbm_CA.run(nsteps=2000000000, report=True, interval=1)
